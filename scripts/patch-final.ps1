$lines = Get-Content "app\app\page.tsx"
...
# Replace lines 865-874 (0-indexed) with new styling block
$newLines = $lines[0..864] + $stylingBlock + $lines[875..($lines.Count-1)]
$newLines | Set-Content "app\app\page.tsx" -Encoding UTF8
